...
COURSE_STRUCTURE = [
    ...
    # ─────────────────────────────────────────────────────────────────
    {
        ...
        "lessons": [
            ...
            {"title": "FizzBuzz и его вариации", "slug": "fizzbuzz", "topic": "conditions_practice", "order": 13,
             "description": "Классическая задача программирования, варианты решения"},
    ...
    # ─────────────────────────────────────────────────────────────────
    {
        ...
        "lessons": [
            ...
            {"title": "Палиндромы и анаграммы", "slug": "palindromes-anagrams", "topic": "strings_practice", "order": 17,
             "description": "Проверка палиндрома, анаграммы через сортировку"},
    ...
    # ─────────────────────────────────────────────────────────────────
    {
        ...
        "lessons": [
            ...
            # День 4: Пользовательские исключения
            {"title": "Создание своих исключений", "slug": "custom-exc", "topic": "custom_exceptions", "order": 13,
             "description": "class MyError(Exception), наследование"},
            {"title": "Информативные исключения", "slug": "exc-messages", "topic": "custom_exceptions", "order": 14,
             "description": "Добавление атрибутов и сообщений"},
            {"title": "Иерархия исключений", "slug": "exc-hierarchy", "topic": "custom_exceptions", "order": 15,
             "description": "BaseException, Exception, их подклассы"},
            {"title": "Best practices обработки ошибок", "slug": "exc-best-practices", "topic": "custom_exceptions", "order": 16,
             "description": "Когда ловить, а когда пробрасывать исключение"},
            # День 5: Отладка
